import 'package:skere_app/presentation/views/customer/list.dart';
import 'package:skere_app/presentation/views/models/screen.dart';
import 'package:skere_app/presentation/views/task/list.dart';
